...
<head>
    ...
    <title>测测你前世是什么人</title>
    <meta name="keywords" content="测测你前世是什么人" />
    <meta name="description" content="测测你前世是什么人" />
    <!-- BAIDU_TONGJI -->
    <!-- WX_USER_INFO -->
            ...
            $.post("do.php", {
                ...
                $("#startbtn").rotate({
                    ...
                    callback: function() {
                        ...
                        var infos = "'" + $("#name").val() + "'的前世是" + info[data] + "。";
                        $(document).attr('title', infos + "测测你前世是什么人");
